jQuery(document).ready(function( $ ) {
  ...
  TxtType.prototype.tick = function() {
      ...
      if(this.txt.length == 0){
        this.txt = '　';
        $(".typewrite > .wrap").css('border-right','0em solid #000');
      }else{
        $(".typewrite > .wrap").css('border-right','0.04em solid #000');
      }
  ...
  for (var i=0; i<elements.length; i++) {
      var toRotate = ["콜밴 서비스", "물류 배송 서비스", "이사 서비스", "공항 픽업 서비스", "장거리 운송 서비스"];
      var period = 2000;
      if (toRotate) {
